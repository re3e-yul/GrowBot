...
def ReadSensors(SensorAdd):
	print "param: ", SensorAdd
	pHSens = atlas_i2c(SensorAdd)        # creates the I2C port object for pH sensor
	pH = round(float(pHSens.query('R')), 3)
	return pH    	
