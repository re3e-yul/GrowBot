...
def Display():
	try:
		...
		if PStatus == 1:
			...
			PStatus = "Off"
		print "Light: ", LStatus
		print "Pump : ", PStatus, " ,LastFlood: ", LastFlood, " ,NextFlood: ",NextFlood
		print ""
...
def SysLog(Deamonstat):
        ...
        try:
                LogString="Deamonstat",Deamonstat,"Lstatus", LStatus,"Pstatus", PStatus,"FStatus", FStatus,"temp", temp,"LastFlood", str(LastFlood),"NextFlood", str(NextFlood),"VBed1", flow3,"VBed2", flow4,"pH", pH, pHVar, "EC", EC, ECVar, "S", S,"SG", SG,"pHDn", pHDn,"pHUp", pHUp,"GrowA", GrowA,"GrowB", GrowB,"FloA", FloA,"FloB", FloB
                LogString=str(LogString)
                syslog.syslog(syslog.LOG_INFO,LogString)
        except NameError:
                LogString="Deamonstat something Lstatus", LStatus,"Pstatus", PStatus,"FStatus", FStatus,"temp", temp,"LastFlood", str(LastFlood),"NextFlood", str(NextFlood),"VBed1", flow3,"VBed2", flow4,"pH", pH, pHVar, "EC", EC, ECVar, "S", S,"SG", SG,"pHDn", pHDn,"pHUp", pHUp,"GrowA", GrowA,"GrowB", GrowB,"FloA", FloA,"FloB", FloB
                LogString=str(LogString)
                syslog.syslog(syslog.LOG_INFO,LogString)
        time.sleep(0.9)
