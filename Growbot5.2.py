	...
	while True:
		try:
			...
			if Deamonstat == "UserLand":
				...
				LogString="Drain1:", flow1, flow1b, "Drain2:", flow2, flow2b, "Pump1:", flow3, "Pump2:", flow4, "SensorThread:", threadStat, "ActuatorThread:", thread2Stat, "RunLevel:", Deamonstat, "Lights:", LStatus, "Pump:", PStatus
