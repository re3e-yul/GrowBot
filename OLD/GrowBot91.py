...
class atlas_i2c():
	...
	default_address = 99
	Sens.default_address = default_address
	print default_address
	print Sens.default_address
...
def ReadSensors(default_address):
	print default_address
    	Sens = atlas_i2c()       # creates the I2C port object for pH sensor
#	pH = round(float(pHSens.query('R')), 3)

default_address = 99
ReadSensors(default_address)
